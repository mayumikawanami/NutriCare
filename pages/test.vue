    ...
    <form class="questionnaire" @submit.prevent="submitAnswers">
      <div class="questionnaire-label" v-for="(question, index) in questions" :key="index">
        ...
        <div class="options-container">
          <input type="radio" :value="0" v-model="answers[index]" :id="'yes-' + index" />
          <label :for="'yes-' + index">はい</label>
          
          <input type="radio" :value="1" v-model="answers[index]" :id="'no-' + index" />
          <label :for="'no-' + index">いいえ</label>
...
button:hover { background-color: #b3f0b6; }
